    ...
    <div class="row">
        <div class="col m4">
            ...
            <p>Sécurité<br>
                ...
                <a class="waves-effect waves-light btn modal-trigger" href="<?= $RssSecurite->channel->item[$i]->link ?>">Lien</a>
        ...
        <div class="col m4">
            ...
            <p>Applis/Logiciels <br>
                ...
                <a class="waves-effect waves-light btn modal-trigger" href="<?= $RssApplisLogiciels->channel->item[$i]->link ?>">Lien</a>
        ...
        <div class="col m4">
            ...
            <p>Technos <br>
                ...
                <a class="waves-effect waves-light btn modal-trigger" href="<?= $RssTechnos->channel->item[$i]->link ?>">Lien</a>
