...
if (isset($_GET) && $_GET['page'] == 'deconnexion'):
    setcookie('Bonjour', 'Salut', time() + 360, '/', 'rssfeed.info', false, true);
    echo $_COOKIE['Bonjour'];
    setcookie('Bonjour', FALSE, time() - 3600, '/', 'rssfeed.info', false, true);
    unset($_COOKIE['Bonjour']);
endif;
...
?>
    <nav class="<?php
        ...
        <div class="nav-wrapper">
            <a href="accueil" class="brand-logo toto">Logoo</a>
        ...
        <div class="col s12 m4">
            <div class="card">
                ...
                <div class="card-action">
                    <a class="waves-effect waves-light btn modal-trigger" style="background-color: <?= $_COOKIE['choiceColor']; ?>" 
        ...
        <div class="col m4">
            ...
            <p>Sécurité<br>
                ...
                <div id="modalHomeCol1<?= $i ?>" class="modal">
                    ...
                    <div class="modal-footer">
                        <a href="<?= $RssSecurite->channel->item[$i]->link ?>"
                            class="waves-effect btn-flat" style="background-color: <?= $_COOKIE['choiceColor']; ?>">Lien vers l'article</a>
                        <a href="#!" class="modal-close waves-effect waves-green btn-flat">Fermer</a>
                    </div>
                </div>
            </p>
